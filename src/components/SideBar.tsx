...
const SideBar = () => {
  return (
    <div className="bg-secondary h-[550px] w-[180px] flex flex-col p-4 text-white gap-2">
      ...
      <span className="mt-6 flex flex-row items-center gap-2 text-[14px]"><p className="text-gray-400 p-1"><AiOutlineCreditCard size={18}/></p>Saldo</span>
      <span className="mt-6 flex flex-row items-center gap-2 text-[14px]"><p className="text-gray-400 p-1"><FaExchangeAlt size={18}/></p>Transacciones</span>
      <span className="mt-6 flex flex-row items-center gap-2 text-[14px]"><p className="text-gray-400 p-1"><FaMoneyBillTransfer size={18}/></p>Enviar</span>
